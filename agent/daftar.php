        ...
        <div class="main-panel">
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        ...
                        <a class="navbar-brand" href="daftar.php">Daftar Agent</a>
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">Daftar Agent</h4></div>
                            <div class="card-content">
                            <form action="" method="POST" class="form-horizontal" id="registerFormValidation">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" align="right">Nama :</label><star>*</star>
                                        <div class="col-sm-4">
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" align="right">Jenis Kelamin :</label>
                                        <div class="col-sm-4">
                                            <div class="col-lg-6">
                                                <div class="radio radio-inline">
                                                    <input type="radio" name="jenis_kelamin" id="cowok" value="Laki-Laki" checked="">
                                                    <label for="cowok">
                                                        Laki-Laki
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="radio radio-inline">
                                                    <input type="radio" name="jenis_kelamin" id="cewek" value="Perempuan">
                                                    <label for="cewek">
                                                        Perempuan
                                                    </label>
                                                </div>
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" align="right">Tanggal Lahir :</label><star>*</star>
                                        <div class="col-sm-4">                          
                                            <div class="input-group">
                                                <input type="text" name="tanggal_lahir" id="tanggal_lahir" class="form-control datetpicker" required ></input>
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" align="right">ID Upline :</label>
                                        <div class="col-sm-4">
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" align="right">No Telp :</label><star>*</star>
                                        <div class="col-sm-4">
                                            <input name="no_telp" id="no_telp" class="form-control" type="text" required></input>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" align="right">Jabatan :</label>
                                        <div class="col-sm-4">
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" align="right">Cabang :</label>
                                        <div class="col-sm-4">
                                            <select name="cabang_id" id="cabang_id" class="form-control" type="text">
                                                <?php 
        ...
        $().ready(function(){
            ...
            $('form').on('submit', function (e) {
                ...
                if(isvalidate){
                    e.preventDefault();
                    if($('#jabatan_id').val() == '2'){
                        var sUser = $('#nama').val().split(" ");
                        var sTanggal = $('#tanggal_lahir').val().split("-");
                        var suggest = "";
                        if(sUser.length > 1){
                            suggest = sUser[0].toLowerCase()+sUser[1].length;
                        }
                        if(sUser.length <= 1){
                            suggest = $('#nama').val().toLowerCase()+sTanggal[1]+sTanggal[2];
                        }
                        swal({
                          title: 'Daftar User',
                          html:
                          ...
                          $.ajax({
                            type: 'post',
                            url: '../proses.php?cmd=daftar_agent',
                            data: $('form').serialize(),
                            success: function (data) {
                                $.ajax({
                                    type: 'post',
                                    url: '../proses.php?cmd=daftar_user',
                                    data: {
                                        'user': result[0],
                                        'pass': result[1],
                                    },
                                    success: function (data) {
                                        $.notify({
                                            ...
                                            message: 'Data agent berhasil untuk disimpan.' 
                                        },{
                                            // settings
                                            type: 'success',
                                            placement: {
                            ...
                            success: function (data) {
                                if(data == 0){
                                    $.notify({
                                        ...
                                        message: 'Principal / Vice Principal sudah ada pada cabang yang dipilih.' 
                                    },{
                                        // settings
                                        type: 'danger',
                                        placement: {
                    ...
                    $.notify({
                        // options
                        icon: 'glyphicon glyphicon-exclamation-sign',
                        message: 'Maaf, data agent gagal untuk disimpan. Silahkan cek kembali.' 
                    },{
                        // settings
                        type: 'danger',
                        placement: {
